...
Official download repository: http://wordpress.org/extend/plugins/wp-cms-post-control - The latest version (and all older versions) of Post Control should ONLY be downloaded from here only.
...
v2.941 - Tested against WordPress 4.6 pre-release trunk development version
v2.940 - Tested against WordPress 4.5
v2.931 - Tested against WordPress 4.4RC1
